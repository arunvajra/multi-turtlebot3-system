...
rospy.init_node('robot9_node') # Initializes a node
pub = rospy.Publisher('/tb3_8/cmd_vel', Twist, queue_size=10)  # Publisher 

sub = rospy.Subscriber('/tb3_8/scan', LaserScan, callback)  # Subscriber 
