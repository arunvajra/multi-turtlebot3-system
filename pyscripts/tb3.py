...
rospy.init_node('robot3_node') # Initializes a node
pub = rospy.Publisher('/tb3_2/cmd_vel', Twist, queue_size=10)  # Publisher object which will publish "Twist" type messages

sub = rospy.Subscriber('/tb3_2/scan', LaserScan, callback)  # Subscriber object which will listen "LaserScan" type messages
