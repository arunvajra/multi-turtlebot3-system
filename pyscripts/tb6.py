...
rospy.init_node('robot6_node') # Initializes a node
pub = rospy.Publisher('/tb3_5/cmd_vel', Twist, queue_size=10)  # Publisher 

sub = rospy.Subscriber('/tb3_5/scan', LaserScan, callback)  # Subscriber 
