...
rospy.init_node('robot7_node') # Initializes a node
pub = rospy.Publisher('/tb3_6/cmd_vel', Twist, queue_size=10)  # Publisher 

sub = rospy.Subscriber('/tb3_6/scan', LaserScan, callback)  # Subscriber 
