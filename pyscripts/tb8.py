...
rospy.init_node('robot8_node') # Initializes a node
pub = rospy.Publisher('/tb3_7/cmd_vel', Twist, queue_size=10)  # Publisher 

sub = rospy.Subscriber('/tb3_7/scan', LaserScan, callback)  # Subscriber 
