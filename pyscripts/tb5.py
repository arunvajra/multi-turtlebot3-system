...
rospy.init_node('robot5_node') # Initializes a node
pub = rospy.Publisher('/tb3_4/cmd_vel', Twist, queue_size=10)  # Publisher 

sub = rospy.Subscriber('/tb3_4/scan', LaserScan, callback)  # Subscriber 
