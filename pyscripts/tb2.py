...
rospy.init_node('robot2_node') # Initializes a node
pub = rospy.Publisher('/tb3_1/cmd_vel', Twist, queue_size=10)  # Publisher 

sub = rospy.Subscriber('/tb3_1/scan', LaserScan, callback)  # Subscriber 
