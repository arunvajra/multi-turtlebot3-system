...
rospy.init_node('robot4_node') # Initializes a node
pub = rospy.Publisher('/tb3_3/cmd_vel', Twist, queue_size=10)  # Publisher 

sub = rospy.Subscriber('/tb3_3/scan', LaserScan, callback)  # Subscriber 
